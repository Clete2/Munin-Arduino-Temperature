...
float getOneWireTempF(int index)
{ 
  DeviceAddress *da;
  if(index == 0){
    da = &insideThermometer;
  }else{
    da = &outsideThermometer;
  }
  ...
  printTemperature(*da); // Use a simple function to print out the data

  return sensors.getTempF(*da);
}
